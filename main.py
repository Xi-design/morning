...
data = {"weather":{"value":weather_today['textDay']},"MaxTemp":{"value":weather_today['tempMax']},"MinTemp":{"value":weather_today['tempMin']},"Featurewea":{"value":weather_tomorrow['textDay'] + ";"  + weather_after_tomorrow['textDay']},"Featuretemp":{"value":weather_tomorrow['tempMax'] + "°C;" + weather_after_tomorrow['tempMax']+"°C."},"birthday_left":{"value":get_birthday()},"words":{"value":get_words(),"color":get_random_color()},"links":{"value":linkdetail}}
